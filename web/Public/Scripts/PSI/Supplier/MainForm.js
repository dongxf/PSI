...
Ext.define("PSI.Supplier.MainForm", {
    ...
    initComponent: function () {
        ...
        var supplierGrid = Ext.create("Ext.grid.Panel", {
            ...
            columns: [
                ...
                {header: "开户行", dataIndex: "bankName", menuDisabled: true, sortable: false},
                {header: "开户行账号", dataIndex: "bankAccount", menuDisabled: true, sortable: false},
                {header: "税号", dataIndex: "tax", menuDisabled: true, sortable: false},
                {header: "传真", dataIndex: "fax", menuDisabled: true, sortable: false},
                ...
                {header: "备注", dataIndex: "note", menuDisabled: true, sortable: false, width: 400}
            ],
            store: store,
            bbar: [{
                    id: "pagingToolbar",
        ...
        Ext.apply(me, {
            ...
            layout: "border",
            tbar: [
                {text: "新增供应商分类", iconCls: "PSI-button-add", handler: this.onAddCategory, scope: this},
                {text: "编辑供应商分类", iconCls: "PSI-button-edit", handler: this.onEditCategory, scope: this},
                {text: "删除供应商分类", iconCls: "PSI-button-delete", handler: this.onDeleteCategory, scope: this}, "-",
                {text: "新增供应商", iconCls: "PSI-button-add-detail", handler: this.onAddSupplier, scope: this},
    ...
    onDeleteCategory: function () {
        ...
        PSI.MsgBox.confirm(info, function () {
            ...
            el.mask("正在删除中...");
            Ext.Ajax.request({
                url: PSI.Const.BASE_URL + "Home/Supplier/deleteCategory",
                method: "POST",
