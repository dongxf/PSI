...
Ext.define("PSI.Permission.EditForm", {
    ...
    initComponent: function () {
        ...
        var permissionGrid = Ext.create("Ext.grid.Panel", {
            ...
            columns: [
                ...
                {header: "数据域", dataIndex: "dataOrg", flex: 1, menuDisabled: true},
                {
                    ...
                    items: [
                        {
                            icon: PSI.Const.BASE_URL + "Public/Images/icons/delete.png", handler: function (grid, row) {
            ...
            tbar: [
                {text: "添加权限", handler: this.onAddPermission, scope: this, iconCls: "PSI-button-add"}, "-",
                {text: "移除权限", handler: this.onRemovePermission, scope: this, iconCls: "PSI-button-delete"}
            ]
        });
        ...
        var userGrid = Ext.create("Ext.grid.Panel", {
            ...
            tbar: [
                {text: "添加用户", iconCls: "PSI-button-add", handler: this.onAddUser, scope: this}, "-",
                {text: "移除用户", iconCls: "PSI-button-delete", handler: this.onRemoveUser, scope: this}
            ]
        });
