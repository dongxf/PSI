Ext.define("PSI.Purchase.PWEditForm", {
    ...
    initComponent: function () {
        ...
        Ext.apply(me, {title: entity == null ? "新建采购入库单" : "编辑采购入库单",
            modal: true,
            onEsc: Ext.emptyFn,
            width: 1000,
            height: 600,
    ...
    getGoodsGrid: function () {
        ...
        me.__goodsGrid = Ext.create("Ext.grid.Panel", {
            ...
            columns: [
                ...
                {header: "采购数量", dataIndex: "goodsCount", menuDisabled: true,
                ...
                {header: "采购单价", dataIndex: "goodsPrice", menuDisabled: true,
                    sortable: false, align: "right", xtype: "numbercolumn",
                    width: 100, editor: {xtype: "numberfield", hideTrigger: true}},
