...
Ext.define("PSI.Funds.PrePaymentMainForm", {
	...
	getMainGrid : function() {
		...
		Ext.define(modelName, {
			extend : "Ext.data.Model",
			fields : [ "id", "supplierId", "code", "name", "inMoney", "outMoney",
					"balanceMoney" ]
		});
	...
	getDetailGrid : function() {
		...
		var store = Ext.create("Ext.data.Store", {
			...
			proxy : {
				...
				url : PSI.Const.BASE_URL + "Home/Funds/prepaymentDetailList",
				reader : {
					root : 'dataList',
					totalProperty : 'totalCount'
				}
		...
		me.__detailGrid = Ext.create("Ext.grid.Panel", {
			...
			columns : [ {
				...
				renderer: function(value, md, record) {
					return "<a href='" + PSI.Const.BASE_URL + "Home/Bill/viewIndex?fid=2026&refType=" 
