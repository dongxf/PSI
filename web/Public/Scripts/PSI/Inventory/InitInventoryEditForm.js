                            ...
                            items: [{
                                    ...
                                    items: [{
                                            ...
                                            items: [{xtype: "container", flex: 1}, {
                                                    id: "buttonSubmit",
                                                    xtype: "button", text: "保存当前商品的建账信息", iconCls: "PSI-button-ok", flex: 2,
                                            ...
                                            layout: "hbox",
                                            items: [{xtype: "container", flex: 1}, {
                                                    xtype: "checkbox", id: "checkboxGotoNext",
                                                    checked: true, fieldLabel: "保存后自动跳转到下一条记录",
                                                    labelWidth: 160, labelSeparator: ""
                                                }, {xtype: "container", flex: 1}]
                                        }]
                                }
                            ]
        ...
        me.__gridGoods = Ext.create("Ext.grid.Panel", {
            ...
            bbar: [{
                    ...
                    listeners: {
                        change: {
                            fn: function () {
                                store.pageSize = Ext.getCmp("_comboCountPerPage").getValue();
                                store.currentPage = 1;
