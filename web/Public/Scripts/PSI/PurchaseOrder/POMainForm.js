...
Ext.define("PSI.PurchaseOrder.POMainForm", {
    ...
    getToolbarCmp: function() {
    	var me = this;
    	return [{
            text: "新建采购订单", iconCls: "PSI-button-add", scope: me, handler: me.onAddBill
        }, "-", {
            text: "编辑采购订单", iconCls: "PSI-button-edit", scope: me, handler: me.onEditBill,
            id: "buttonEdit"
        }, "-", {
    ...
    onDeleteBill: function () {
        ...
        var info = "请确认是否删除采购订单: <span style='color:red'>" + bill.get("ref") + "</span>";
        var me = this;
    ...
    onCommit: function () {
        ...
        var info = "请确认是否审核单号: <span style='color:red'>" + bill.get("ref") + "</span> 的采购订单?";
        var id = bill.get("id");
        PSI.MsgBox.confirm(info, function () {
            var el = Ext.getBody();
            el.mask("正在提交中...");
