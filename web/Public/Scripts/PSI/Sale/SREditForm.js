    ...
    getGoodsGrid: function () {
        ...
        me.__goodsGrid = Ext.create("Ext.grid.Panel", {
            ...
            columns: [
                ...
                {header: "退货数量", dataIndex: "rejCount", menuDisabled: true, draggable: false,
                ...
                {header: "退货单价", dataIndex: "rejPrice", menuDisabled: true, draggable: false,
                ...
                {header: "销售金额", dataIndex: "goodsMoney", menuDisabled: true, draggable: false,
                    sortable: false, align: "right", xtype: "numbercolumn",
                    width: 120},
                {header: "序列号", dataIndex: "sn", menuDisabled: true, draggable: false,
                    sortable: false}
            ],
            store: store,
            listeners: {
