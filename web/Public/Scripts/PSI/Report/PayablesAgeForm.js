...
Ext.define("PSI.Report.PayablesAgeForm", {
    ...
    getMainGrid: function() {
        ...
        Ext.define(modelName, {
            ...
            fields: ["caType", "caCode", "caName", "balanceMoney", "money30", 
        ...
        var store = Ext.create("Ext.data.Store", {
            ...
            proxy: {
                ...
                url: PSI.Const.BASE_URL + "Home/Report/payablesAgeQueryData",
                reader: {
                    root: 'dataList',
        ...
        me.__mainGrid = Ext.create("Ext.grid.Panel", {
            ...
            columns: [
                {xtype: "rownumberer"},
                {header: "往来单位性质", dataIndex: "caType", menuDisabled: true, sortable: false},
                {header: "往来单位编码", dataIndex: "caCode", menuDisabled: true, sortable: false},
                {header: "往来单位", dataIndex: "caName", menuDisabled: true, sortable: false, width: 200},
    ...
    querySummaryData: function() {
        ...
        Ext.Ajax.request({
            url: PSI.Const.BASE_URL + "Home/Report/payablesSummaryQueryData",
            method: "POST",
