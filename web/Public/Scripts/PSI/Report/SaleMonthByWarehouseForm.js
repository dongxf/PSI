// 销售月报表(按仓库汇总)
Ext.define("PSI.Report.SaleMonthByWarehouseForm", {
    ...
    getMainGrid: function() {
    	...
    	var modelName = "PSIReportSaleMonthByWarehouse";
        ...
        var store = Ext.create("Ext.data.Store", {
            ...
            proxy: {
                ...
                url: PSI.Const.BASE_URL + "Home/Report/saleMonthByWarehouseQueryData",
                reader: {
                    root: 'dataList',
        ...
        me.__mainGrid = Ext.create("Ext.grid.Panel", {
            ...
            columns: [
                ...
                {header: "仓库", dataIndex: "warehouseName", menuDisabled: true, sortable: false},
    ...
    getSummaryGrid: function() {
    	...
    	var modelName = "PSIReportSaleMonthByWarehouseSummary";
        Ext.define(modelName, {
            extend: "Ext.data.Model",
    ...
    refreshSummaryGrid: function() {
        ...
        Ext.Ajax.request({
            url: PSI.Const.BASE_URL + "Home/Report/saleMonthByWarehouseSummaryQueryData",
