    ...
    getMainGrid: function() {
        ...
        var store = Ext.create("Ext.data.Store", {
            ...
            proxy: {
                ...
                url: PSI.Const.BASE_URL + "Home/Report/inventoryUpperQueryData",
                reader: {
                    root: 'dataList',
        ...
        me.__mainGrid = Ext.create("Ext.grid.Panel", {
            ...
            columns: [
                ...
                {header: "库存上限", dataIndex: "iuCount", menuDisabled: true, sortable: false,
                	align: "right", xtype: "numbercolumn", format: "0"},
                {header: "当前库存", dataIndex: "invCount", menuDisabled: true, sortable: false,
                	align: "right", xtype: "numbercolumn", format: "0"},
                {header: "存货超量", dataIndex: "delta", menuDisabled: true, sortable: false,
                    align: "right", xtype: "numbercolumn", format: "0",
