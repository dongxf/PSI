...
Ext.define("PSI.Report.SaleDayByGoodsForm", {
    ...
    getMainGrid: function() {
        ...
        me.__mainGrid = Ext.create("Ext.grid.Panel", {
            ...
            columns: [
                {xtype: "rownumberer"},
                {header: "业务日期", dataIndex: "bizDT", menuDisabled: true, sortable: false},
                ...
                {header: "销售出库数量", dataIndex: "saleCount", menuDisabled: true, sortable: false, align: "right", xtype: "numbercolumn"},
